...
| Метрика                     | Группа A (Контрольная) | Группа B (Экспериментальная) | Разница (%) | 
|-----------------------------|-------------------------|-------------------------------|-------------|
| Уровень удовлетворенности    | 75%                     | 85%                           | +10%        | 
| Количество новых подписок    | 100                     | 150                           | +50%        | 
| Среднее время в приложении   | 10 мин                  | 15 мин                        | +50%        | 
| Количество активных пользователей | 500                   | 600                           | +20%        | 
| Уровень оттока (Churn rate) | 5%                      | 3%                            | -40%        | 
| Средний доход на пользователя (ARPU) | $10               | $15                           | +50%        | 
| Количество обращений в службу поддержки | 50             | 30                            | -40%        | 
| Уровень вовлеченности (Engagement rate) | 60%            | 75%                           | +25%        | 
